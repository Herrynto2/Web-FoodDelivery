                    ...
                    <Navbar light expand="md" className="p-3 ">
                        ...
                        <Collapse navbar className="collapse navbar-collapse">
                            <Nav className="ml-auto mr-5" navbar>
                                ...
                                <NavItem >
                                    <NavLink><Link to="/browse-restaurant" className="ml-3 text-decoration-none" href="/components/"><span className="textsub">Restaurant</span></Link></NavLink>
                                </NavItem>
                                <NavItem >
                                    <NavLink><Link to="/cart" className="ml-4 mr-3 margin text-decoration-none cartsub" href="/components/"><img src={cart} width="30px" alt="" /></Link>
                                    </NavLink>
                                </NavItem>
                                <NavItem >
                                    <NavLink><Link to="/profile" className="ml-4 mr-3 margin text-decoration-none cartsub" href="/components/"><img src={profile} width="30px" alt="" /></Link>
                                    </NavLink>
                                </NavItem>
                                <NavItem >
                                    <NavLink>
