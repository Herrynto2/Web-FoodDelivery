    ...
    render() {
        return (
            <div className="col-lg-3">
                <Link to={`/detail-restaurant/${this.props.id}`} className="text-decoration-none">
                    <div className="card  text-center cardresto mb-5">
                        <img src={process.env.REACT_APP_API_URL + this.props.logo} className="card-img-top imgitems" />
